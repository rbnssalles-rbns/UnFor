...
# Chaves de API
# -------------------------------
API_KEY_ORS = "SUA_CHAVE_ORS"
API_KEY_OPENCAGE = "SUA_CHAVE_OPENCAGE"
...
if arquivo:
    ...
    # Mostrar tabela para validar geocodificação
    st.write(df[["Cliente_ID","Cliente","Endereco","Latitude","Longitude","DATA"]])

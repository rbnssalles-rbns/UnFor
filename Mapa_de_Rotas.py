...
# BLOCO 2 — Importação da base única (revisado)
...
if arquivo_base:
    ...
    # Criar coluna apenas com a data (hora zerada, tipo datetime64[ns])
    df_base["ABERTURA_DATA"] = df_base["ABERTURA"].dt.normalize()
...
# BLOCO 3 — Filtros e simulação (revisado)

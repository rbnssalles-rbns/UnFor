...
if arquivo:
    ...
    for i, ((cliente_id, rota_nome), grupo) in enumerate(df.groupby(["Cliente_ID","Cliente"])):
        ...
        # Camada dos ícones com pins customizados (centro branco)
        icon_layer = pdk.Layer(
            ...
            icon_mapping={
                "cd": {
                    ...
                    "url": cd_marker_url  # ícone pin com centro branco fixo para CD
                },
                "cliente": {
                    "x": 0, "y": 0, "width": 128, "height": 128,
                    "anchorY": 128, "mask": True,
                    "url": client_marker_url  # ícone pin com centro branco para clientes
                }
            }
        )

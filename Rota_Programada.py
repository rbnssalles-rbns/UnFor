...
if arquivo:
    ...
    for i, ((cliente_id, rota_nome), grupo) in enumerate(df.groupby(["Cliente_ID","Cliente"])):
        ...
        # Interior branco
        icon_layer_white = pdk.Layer(
            "IconLayer",
            data=icon_data_white,
            get_icon="icon",
            get_size=icon_size,
        ...
        icon_layer_border = pdk.Layer(
            ...
            get_icon="icon",
            get_size=icon_size,
            size_scale=size_scale * 1.2,  # ligeiramente maior para parecer borda
            get_position='[lon, lat]',
            get_color="color",
            pickable=True,
            icon_atlas="https://raw.githubusercontent.com/visgl/deck.gl-data/master/website/icon-atlas.png",
        ...
        layers.extend([path_layer, icon_layer_border, icon_layer_white])
